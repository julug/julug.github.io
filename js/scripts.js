       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Waknaghat",  /* You can change your address from here */
            html: "<b>Jaypee University of Information Technology</b>: <br> Solan, Himachal Pradesh-173234, India",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
